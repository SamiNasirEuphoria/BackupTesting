...
Shader "Skycube/Sky/RGBM SkyboxMap XSI" {
	Properties {
		...
		_SkyTex ("RGBM SkyMap(XSI Cubemap)", 2D) = "white" {}
	...
	SubShader {
		...
		Pass {
			...
			v2f vert (appdata_t v)
			{
				...
				o.texcoord = GetXSICubeMapping_UV2UV(4,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = GetXSICubeMapping_UV2UV(5,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = GetXSICubeMapping_UV2UV(0,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = GetXSICubeMapping_UV2UV(1,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = GetXSICubeMapping_UV2UV(2,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = GetXSICubeMapping_UV2UV(3,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
