...
Shader "Skycube/Sky/RGBM SkyboxMap BoxMapping" {
	Properties {
		...
		_SkyTex ("RGBM SkyTex(Box Mapping)", 2D) = "white" {}
	...
	SubShader {
		...
		Pass {
			...
			v2f vert (appdata_t v)
			{
				...
				o.texcoord = SC_GetSkyBoxUV(4,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = SC_GetSkyBoxUV(5,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = SC_GetSkyBoxUV(0,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = SC_GetSkyBoxUV(1,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = SC_GetSkyBoxUV(2,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
		...
		Pass{
			...
			v2f vert (appdata_t v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.texcoord = SC_GetSkyBoxUV(3,v.texcoord,half4(_XScale,_XOffset,_YScale,_YOffset));
				return o;
			}
