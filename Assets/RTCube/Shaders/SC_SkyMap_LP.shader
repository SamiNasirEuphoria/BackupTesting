...
Shader "Skycube/Sky/SkyboxMap LP" {
Properties {
	_Tint ("Tint Color", Color) = (.5, .5, .5, .5)
	_SkyTex ("SkyMap(Light Probe)", 2D) = "white" {}
...
SubShader {
	...
	Pass {
		...
		{
			fixed4 tex = SC_texCUBEMap_LP(_SkyTex, i.texcoord, half4(_XScale,_XOffset,_YScale,_YOffset));
			fixed4 col;
