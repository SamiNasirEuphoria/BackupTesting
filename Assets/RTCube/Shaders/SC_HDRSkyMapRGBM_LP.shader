...
Shader "Skycube/Sky/RGBM SkyboxMap LP" {
Properties {
	_Tint ("Tint Color", Color) = (.5, .5, .5, .5)
	_SkyTex ("RGBM SkyMap(Light Probe)", 2D) = "white" {}
...
SubShader {
	...
	Pass {
		...
		{
			fixed4 tex = SC_texCUBEMapRGBM_LP(_SkyTex, i.texcoord, _Range, _EV, half4(_XScale,_XOffset,_YScale,_YOffset));
			fixed4 col;
